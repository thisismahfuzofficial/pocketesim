...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        <a href="{{ route('voyager.countries.sync', 'all') }}" class="btn btn-info btn-add-new">
            <i class="voyager-down-circled"></i> <span>Sync</span>
        </a>
                                    ...
                                    @foreach ($dataTypeContent as $data)
                                        <tr>
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                <a href="{{ route('voyager.countries.sync', $data->code) }}"
                                                    class="btn btn-info btn-add-new">
                                                    <i class="voyager-down-circled"></i> <span>Sync</span>
                                                </a>
                                                <a href="{{ route('voyager.plans.index', ['key' => 'country_id', 'filter' => 'equals', 's' => $data->name]) }}"
                                                    class="btn btn-info btn-add-new">
                                                    <i class="voyager-backpack"></i> <span>Plans</span>
                                                </a>
                                                @foreach ($actions as $action)
                                                    @if (!method_exists($action, 'massAction'))
